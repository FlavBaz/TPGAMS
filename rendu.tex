...
- faire le customer networks
- comment lancer les codes en ligne
- tester le 4wt avec les solveurs adaptés pour chaqun des 3 cas
- faire parreil pour le CN
- faire les tableaux et la redaction
...
\begin{tabular}{@{}llll@{}}
\toprule
\textbf{Modèle} & \textbf{Solveur} & \textbf{Algorithme} & \textbf{Options} \\
\midrule
MINLP complet & DICOPT & OA (Outer Approximation) & optcr=0.01, reslim=300 \\
MINLP complet & BARON & Branch-and-Reduce & optcr=0.01, reslim=300 \\
Sans pression & CPLEX & Branch-and-Cut & optcr=0.01, reslim=30 \\
Relax. convexe & DICOPT & OA & optcr=0.01, reslim=60 \\
\bottomrule
\end{tabular}
\caption{Solveurs et configurations testés}
\label{tab:solveurs}
\end{table}
...
Les résultats obtenus sur ces 2 runs sont dans le tableau \ref{tab:runs_minlp}.

Description BARON branch and bond
...
\toprule
\textbf{Run} & \textbf{Coût (€)} & \textbf{Borne inf. (€)} & \textbf{Gap (\%)} & \textbf{Temps (s)}  \\
\midrule
BARON 1 (8h)   & 11.0006 & 9.8446 & 10.5 & 28\,902 \\
BARON 2 (300s) & 11.4363 & 9.8446     & 13.9   & 300     \\
\midrule
