...
\large Projet d'optimisation MINLP}
...
Relax. convexe & DICOPT &  7.60 & &  \\
Relax. convexe & BARON  &  7.37 & &  \\
\midrule
...
Même résulat pour CPLEX sans Pression et BARON relaxation convexe, résulat différent avec DICOPT relaxation convexe, il y a probablement une erreur, mais j'ai pas le temps de la chercher pour le moment.
...
\begin{tabular}{@{}lcccccc@{}}
\toprule
\textbf{Modèle} & \textbf{Solveur} & \textbf{Borne inf (€)} & \textbf{Borne supp.}  & \textbf{Temps (s)} \\
\midrule
MINLP complet & BARON & 256 & 315 & Pas de solution en temps raisonnable \\
Sans pression & CPLEX & 188 & &  /~2s \\
Relax. convexe & DICOPT &  188 & 190 & Pas de solution en temps raisonnable  \\
\midrule
\multicolumn{2}{@{}l}{\textit{Référence (sujet)}} & 235.94 / 218.85 / 235.45 & -- &  400 / 30 / 60 \\
\bottomrule
\end{tabular}
\caption{Résultats obtenus pour le customer network}
\label{tab:resultats}
\end{table}
